...
\mySubHeadingListStart
  \mySubHeading
  {Software Engineer I}{Feb 2022 -- Present}
  {NASA - TOSC, Command \& Control}{Kennedy Space Center, FL, USA}
    \myItemListStart
      ...
      \myItem{Created design presentations and coordinated strategy between workgroups to implement PLC functionality in emulation}
    \myItemListEnd
